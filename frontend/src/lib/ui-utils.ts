 ...
 * Shared UI Utilities
 *
 * Common UI helper functions for displaying toasts and confirmation dialogs.
 * Extracted from auth.ts and admin-auth.ts to avoid code duplication.
 */
 ...
 * Usage:
 * ```typescript
 * import { showToast } from '@/lib/ui-utils';
 ...
 * Usage:
 * ```typescript
 * import { showConfirm } from '@/lib/ui-utils';
